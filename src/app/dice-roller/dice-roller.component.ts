...
@Component({
  ...
  template: `
    <div class="h-full bg-gray-900 flex flex-col transition-all ease-in border-l border-gray-800" [ngClass]="{'w-[480px]': isOpen(), 'w-0': !isOpen()}">
      @if(isOpen()){
        ...
        <div class="flex p-4 border-t border-gray-800">
          <input
            class="w-full rounded bg-gray-800 py-1 px-3 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
